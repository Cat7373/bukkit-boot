...
public class SummonCommandGeneratorV1 implements ISummonCommandGenerator {
    ...
    private String getNMSName(Entity entity) throws Exception {
        ...
        Object entityToStringMap = Reflects.readField(EntityTypesClass, null, "d");
        ...
        return Reflects.invoke(Map.class, entityToStringMap, "get", new Class<?>[] { Object.class }, NMSEntity.getClass()).toString();
    }
